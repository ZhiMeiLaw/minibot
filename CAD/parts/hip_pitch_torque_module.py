"""
Hip Pitch Torque Module (V6-PRT-0012)
Mini-Atlas V6 Alpha
Double clamp hub | 2x M3 clamp screws | PCD 18mm
Ref: CDS-04C, ECO-001
"""
...
doc = App.newDocument("HipPitchTorqueModule")
...
doc.recompute()
out = os.path.join(STL_DIR, "hip_pitch_torque_module.stl")
mesh = Mesh.Mesh()
...
print(f"[OK] hip_pitch_torque_module.stl -> {out}")