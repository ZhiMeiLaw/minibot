...
> **ECO-001 变更**：踝关节已取消（DR-011），移除 STS3215 维护计划。原 STS3215 备件不再需要。
...
> **ECO-001 变更**：轴承系统由 6803/6802（Ø17/Ø15 轴）更新为 688/698（Ø8 轴配合）。踝关节取消后，6801-2RS 备件不再需要。
...
> **ECO-001 变更**：踝关节取消，移除 STS3215 备件成本（70 RMB）。
